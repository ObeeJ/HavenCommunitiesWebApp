...
function TextPadding() {
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[2px] py-0 relative shrink-0" data-name="Text padding">
      <p className="font-['Avenir:Medium',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#a4a7ae] text-[16px] text-nowrap whitespace-pre">Subscribe</p>
    </div>
  );
}
...
function ButtonsButton() {
  return (
    <div className="relative rounded-[234px] shrink-0" data-name="Buttons/Button">
