...
function Navigation({ onNavigate }: { onNavigate?: (page: 'home' | 'about' | 'contact' | 'projects' | 'blog') => void }) {
  return (
...
function Content({ onNavigate }: { onNavigate?: (page: 'home' | 'about' | 'contact' | 'projects' | 'blog') => void }) {
  return (
...
function Header({ onNavigate }: { onNavigate?: (page: 'home' | 'about' | 'contact' | 'projects' | 'blog') => void }) {
  return (
...
function DropdownHeaderNavigation({ onNavigate }: { onNavigate?: (page: 'home' | 'about' | 'contact' | 'projects' | 'blog') => void }) {
  return (
...
function Globe05() {
  return (
    <div className="absolute left-[12px] size-[24px] top-[12px]" data-name="globe-05">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="globe-05">
          <path d={svgPaths.p1962f600} id="Icon" stroke="var(--stroke-0, #155EEF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function TextAndAction5() {
  return (
    <div 
      className="backdrop-blur-[1px] backdrop-filter bg-[rgba(255,255,255,0.3)] box-border content-stretch flex flex-col gap-[12px] h-[64px] items-center justify-center px-[20px] py-[24px] relative rounded-[234px] shrink-0 w-[264px] cursor-pointer hover:opacity-90 transition-opacity" 
...
function Content14({ value, onChange }: { value: string; onChange: (e: React.ChangeEvent<HTMLInputElement>) => void }) {
  return (
...
function SocialIcon2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Social icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_31_2223)" id="Social icon">
...
function SocialIcon3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Social icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_31_2399)" id="Social icon">
          <g id="Vector">
...
function SocialIcon5() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Social icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_31_2278)" id="Social icon">
...
function Content15({ onNavigate, email, setEmail, onSubmit }: { onNavigate?: (page: 'home' | 'about' | 'contact' | 'projects' | 'blog') => void; email: string; setEmail: (e: React.ChangeEvent<HTMLInputElement>) => void; onSubmit: () => void }) {
  return (
...
function Container9({ onNavigate, email, setEmail, onSubmit }: { onNavigate?: (page: 'home' | 'about' | 'contact' | 'projects' | 'blog') => void; email: string; setEmail: (e: React.ChangeEvent<HTMLInputElement>) => void; onSubmit: () => void }) {
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full" data-name="Container">
      <div className="max-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[48px] items-start max-w-inherit px-[32px] py-0 relative w-full">
          <Content15 onNavigate={onNavigate} email={email} setEmail={setEmail} onSubmit={onSubmit} />
        </div>
      </div>
    </div>
  );
...
function Content16({ onNavigate }: { onNavigate?: (page: 'terms' | 'privacy' | 'cookies') => void }) {
  return (
...
function Footer({ onNavigate, email, setEmail, onSubmit, onPolicyNavigate }: { onNavigate?: (page: 'home' | 'about' | 'contact' | 'projects' | 'blog') => void; email: string; setEmail: (e: React.ChangeEvent<HTMLInputElement>) => void; onSubmit: () => void; onPolicyNavigate?: (page: 'terms' | 'privacy' | 'cookies') => void }) {
  return (
    <div className="bg-[#155eef] box-border content-stretch flex flex-col gap-[64px] items-center overflow-clip pb-[48px] pt-[64px] px-0 relative shrink-0 w-full z-[1]" data-name="Footer">
      <Container9 onNavigate={onNavigate} email={email} setEmail={setEmail} onSubmit={onSubmit} />
      <Container10 onNavigate={onPolicyNavigate} />
    </div>
  );
}

export default function Desktop({ onNavigate, onPolicyNavigate }: { onNavigate?: (page: 'home' | 'about' | 'contact' | 'projects' | 'blog') => void; onPolicyNavigate?: (page: 'terms' | 'privacy' | 'cookies') => void }) {
