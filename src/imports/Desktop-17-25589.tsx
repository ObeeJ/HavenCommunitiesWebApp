import svgPaths from "./svg-rgmwoql14m";
...
import imgLogo from "figma:asset/3eada838a8a55b948f7379c648ac717c0e7f47c9.png";

function Frame1000003793() {
  return (
    <div className="relative w-[90px] h-[60px] flex items-center">
      <img
...
function Container() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full max-w-[1320px] mx-auto px-[16px] md:px-[24px] lg:px-[32px]" data-name="Container">
      <Content />
    </div>
  );
}
...
function Header() {
  return (
    <div className="absolute content-stretch flex flex-col h-[100px] items-center justify-center left-0 right-0 top-0" data-name="Header">
      <Container />
    </div>
  );
}
...
function Frame1000003788() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0">
      <p className="font-['Avenir:Heavy',_sans-serif] leading-[72px] not-italic relative shrink-0 text-[64px] text-white tracking-[-1.28px] w-[850px]">Crafting spaces, cultivating communities</p>
      ...
      <p className="font-['Avenir:Regular',_sans-serif] leading-[30px] not-italic relative shrink-0 text-[20px] text-white w-[850px]">We are in the service of creating communities where people feel safe, loved and protected.</p>
    </div>
  );
}
...
function HeadingAndSupportingText() {
  return (
    <div className="content-stretch flex gap-[32px] items-start justify-between relative shrink-0 w-full" data-name="Heading and supporting text">
      <HeadingAndAction />
    </div>
  );
}
...
function Container1() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[12px] items-start left-0 right-0 mx-auto max-w-[1280px] px-[16px] md:px-[24px] lg:px-[32px] py-0 top-[120px] w-full" data-name="Container">
...
function Frame3() {
  return (
    <div className="h-[603px] relative shrink-0 w-full z-[1]">
      <div className="absolute bg-[rgba(0,0,0,0.4)] h-[683px] left-0 right-0 top-0 w-full" />
      <Container1 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col h-[683px] isolate items-center overflow-clip relative shrink-0 w-full z-[11]" data-name="Hero header section">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        ...
        <img alt="" className="absolute max-w-none object-center object-cover size-full" src={imgHeroHeaderSection} />
      </div>
      <Frame4 />
      <Frame3 />
    </div>
  ...
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full mx-auto" data-name="Container">
      <div className="max-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[64px] items-start max-w-inherit px-[16px] md:px-[24px] lg:px-[32px] py-0 relative w-full">
          <Content1 />
          <Content2 />
        </div>
      </div>
...
function Container3() {
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full mx-auto" data-name="Container">
      <div className="max-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[32px] items-start max-w-inherit px-[16px] md:px-[24px] lg:px-[32px] py-0 relative w-full">
          <Content3 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full mx-auto" data-name="Container">
      <div className="flex flex-row items-center max-w-inherit size-full">
        <div className="box-border content-stretch flex gap-[64px] items-center max-w-inherit px-[16px] md:px-[24px] lg:px-[32px] py-0 relative w-full">
          <Content7 />
          <Content8 />
        </div>
      </div>
...
function Frame1000003789() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-[1216px]">
      <Card5 />
      <Card6 />
      <Card7 />
    </div>
  ...
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full mx-auto" data-name="Container">
      <div className="flex flex-col items-center max-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[64px] items-center max-w-inherit px-[16px] md:px-[24px] lg:px-[32px] py-0 relative w-full">
          <Container5 />
          <Content10 />
        </div>
      </div>
...
function HeadingAndSupportingText4() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start not-italic relative shrink-0 text-white w-full" data-name="Heading and supporting text">
      ...
      <p className="font-['Avenir:Regular',_sans-serif] leading-[30px] relative shrink-0 text-[20px] w-[558px]">Are you looking to buy land, build a home or invest with us?</p>
    </div>
  );
}
...
function Content12() {
  return (
    <div className="basis-0 grow h-[480px] min-h-px min-w-px relative shrink-0" data-name="Content">
      <div className="absolute bg-[rgba(0,0,0,0.4)] h-[480px] left-0 right-0 rounded-[24px] top-0 w-full" />
      <Content11 />
    </div>
  );
}
  ...
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full mx-auto" data-name="Container">
      <div className="flex flex-row items-center justify-center max-w-inherit size-full">
        <div className="box-border content-stretch flex items-center justify-center max-w-inherit px-[16px] md:px-[24px] lg:px-[32px] py-0 relative w-full">
          <Content13 />
        </div>
      </div>
    </div>
...
function Frame1000003794() {
  return (
    <div className="relative shrink-0 w-[105px] h-[68px]">
      <img alt="Haven Communities Logo" src={imgLogo} className="w-full h-full object-contain" />
    </div>
  );
}
...
function Container9() {
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full mx-auto" data-name="Container">
      <div className="max-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[48px] items-start max-w-inherit px-[16px] md:px-[24px] lg:px-[32px] py-0 relative w-full">
          <Content15 />
        </div>
      </div>
    </div>
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative w-full min-h-screen" data-name="Desktop">
      <HeroHeaderSection />
      <TestimonialSection />
      <FeaturesSection />
      <TestimonialSection1 />
