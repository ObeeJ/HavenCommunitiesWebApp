...
function HeroHeaderSection({ onNavigate }: NavigationProps) {
  return (
    <div className="content-stretch flex flex-col h-[476px] md:h-[683px] isolate items-center overflow-clip relative shrink-0 w-full z-[6]" data-name="Hero header section">
