...
function ContentItem1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <PaddingTop />
      <p className="font-['Avenir:Heavy',_sans-serif] leading-[32px] not-italic relative shrink-0 text-[#101828] text-[24px] w-full">Introduction</p>
      <PaddingBottom />
    </div>
  );
}
...
function ContentItem2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <p className="font-['Avenir:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#475467] text-[16px] w-full">{`Welcome to Pishon! This Cookie Policy explains in detail how we use cookies, web beacons, and similar technologies (collectively referred to as "cookies") on our website and platform. By using Pishon, you consent to the use of cookies as described in this policy.`}</p>
    </div>
  );
}
...
function ContentItem3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <PaddingTop1 />
      <p className="font-['Avenir:Heavy',_sans-serif] leading-[32px] not-italic relative shrink-0 text-[#101828] text-[24px] w-full">What are Cookies?</p>
      <PaddingBottom1 />
    </div>
  );
}
...
function ContentItem4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <p className="font-['Avenir:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#475467] text-[16px] w-full">Cookies are small text files that are placed on your device when you visit a website. They serve various purposes, such as enabling website functionality, improving user experience, and providing analytical information. Cookies can be categorized based on their lifespan and purpose.</p>
    </div>
  );
}
...
function ContentItem5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <PaddingTop2 />
      <p className="font-['Avenir:Medium',_sans-serif] leading-[30px] not-italic relative shrink-0 text-[#101828] text-[20px] w-full">Types of Cookies We Use</p>
      <PaddingBottom2 />
    </div>
  );
}
...
function ContentItem7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <PaddingTop3 />
      <p className="font-['Avenir:Medium',_sans-serif] leading-[30px] not-italic relative shrink-0 text-[#101828] text-[20px] w-full">Cookie Management</p>
      <PaddingBottom3 />
    </div>
  );
}
...
function ContentItem9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <PaddingTop4 />
      <p className="font-['Avenir:Medium',_sans-serif] leading-[30px] not-italic relative shrink-0 text-[#101828] text-[20px] w-full">Consent to Cookie Usage</p>
      <PaddingBottom4 />
    </div>
  );
}
...
function ContentItem11() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <PaddingTop5 />
      <p className="font-['Avenir:Heavy',_sans-serif] leading-[32px] not-italic relative shrink-0 text-[#101828] text-[24px] w-full">Third-Party Cookies and Externals Links</p>
      <PaddingBottom5 />
    </div>
  );
}
...
function ContentItem13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <PaddingTop6 />
      <p className="font-['Avenir:Medium',_sans-serif] leading-[30px] not-italic relative shrink-0 text-[#101828] text-[20px] w-full whitespace-pre-wrap">{`Changes to the  Cookie Policy`}</p>
      <PaddingBottom6 />
    </div>
  );
}
...
function ContentItem14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <p className="font-['Avenir:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#475467] text-[16px] w-full">We may update this Cookie Policy from time to time to reflect changes in our practices or for legal or regulatory reasons. We will notify you of any material changes by posting the updated policy on our website or through other communication channels.</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content item">
      <div className="font-['Avenir:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#475467] text-[0px] text-[16px] w-full">
        <p className="mb-[16px]">
          <span>{`If you have any questions or concerns about our use of cookies or this Cookie Policy, please contact us at `}</span>
          <span className="font-['Avenir:Medium',_sans-serif] not-italic">contact@pishon.org</span>
          <span className="font-['Avenir:Regular',_sans-serif] not-italic">. We are here to assist you and address any inquiries you may have.</span>
        </p>
        <p className="mb-[16px]">Please note that this Cookie Policy should be read in conjunction with our Privacy Policy, which provides more information about how we collect, use, and protect your personal information.</p>
        <p>{`By using Pishon's website and platform, you acknowledge that you have read, understood, and agreed to be bound by this Cookie Policy.`}</p>
      </div>
    </div>
  );
}
...
function Content9({ onNavigate }: { onNavigate?: (page: 'home' | 'about' | 'contact' | 'projects' | 'projectDetail' | 'blog' | 'blogDetail' | 'privacyPolicy' | 'termsOfService' | 'cookiesPolicy') => void }) {
  return (
