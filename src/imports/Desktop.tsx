import svgPaths from "./svg-du0thgo012";
...
function Container() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[1320px] mx-auto" data-name="Container">
      <Content />
    </div>
  );
}
...
function Frame1000003788() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full">
      <p className="font-['Avenir:Heavy',_sans-serif] leading-[72px] not-italic relative shrink-0 text-[64px] text-white tracking-[-1.28px] w-full">Crafting spaces, cultivating communities</p>
...
function Container1() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[12px] items-start left-0 right-0 mx-auto max-w-[1280px] px-[32px] py-0 top-[120px] w-full" data-name="Container">
  ...
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full mx-auto" data-name="Container">
      <div className="flex flex-row items-center max-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col md:flex-row gap-[64px] items-center max-w-inherit px-[32px] py-0 relative w-full">
          <Content7 />
          <Content8 />
        </div>
      </div>
...
function StarIcon5() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Star icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_4_21654)" id="Star icon">
          <path d={svgPaths.p2f878000} fill="var(--fill-0, #F5F5F5)" id="Star background" />
          <g clipPath="url(#clip1_4_21654)" id="Star">
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Verified tick">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_4_21639)" id="Verified tick">
...
function Container7() {
  return (
    <div className="h-px relative shrink-0 w-full max-w-[1280px] mx-auto" data-name="Container">
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative min-h-screen w-full overflow-x-hidden" data-name="Desktop">
      <HeroHeaderSection />
      <TestimonialSection />
      <FeaturesSection />
      <TestimonialSection1 />
