...
const FeaturesSection: FunctionComponent = () => {
  return (
    <div className="self-stretch py-24 bg-neutral-50 inline-flex flex-col justify-start items-center gap-16 overflow-hidden">
        ...
        <div className="self-stretch flex flex-col justify-start items-center gap-8">
          <div className="w-full max-w-[768px] flex flex-col justify-start items-center gap-5">
            <div className="self-stretch flex flex-col justify-start items-start gap-3">
              <div className="self-stretch text-center justify-start text-gray-900 text-4xl font-extrabold font-['Avenir'] leading-10">Our Core Values</div>
            </div>
            <div className="self-stretch text-center justify-start text-gray-600 text-xl font-normal font-['Avenir'] leading-8">Our shared values keep us connected and guide us as one team.</div>
          </div>
        </div>
      </div>
