...
import styles from './CoreValuesMobile.module.css';
        ...
        <div className={styles.valuesContainer}>
          ...
          <div className={styles.valueItem}>
            <div className={styles.iconContainer}>
              <svg className={styles.icon} viewBox="0 0 24 24" fill="none" stroke="#414651" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
